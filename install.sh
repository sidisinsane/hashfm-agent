...
# ---
# name: install
# description: hashfm-agent install script for macOS and Linux.
# usage: curl -o- https://raw.githubusercontent.com/sidisinsane/hashfm-agent/main/install.sh | bash
# exits:
#   0: success
#   1: fail
# ---
...
GITHUB_REPO="hashfm-agent"
BINARY_NAME="hashfm-agent"
